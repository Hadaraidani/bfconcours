...
const enamQuestions: Question[] = [
  ...
  { id: 1, category: 'francais', question: "Quel est le synonyme de \"rapide\" ?", options: ["Lent", "Véloce", "Lourd", "Petit"], correctAnswers: [1]},
...
const examCategories: CategoryConfig[] = [
  {id: 'francais', name : 'Français', questionsCount: 8},
  { id: 'maths', name: 'Mathématiques', questionsCount: 8 },
  { id: 'physique', name: 'Physique', questionsCount: 7 },
  { id: 'svt', name: 'SVT', questionsCount: 7 },
  { id: 'psychotechnique', name: 'Psychotechnique', questionsCount: 7 },
  { id: 'culture', name: 'Culture Générale', questionsCount: 7 },
  { id: 'histoire', name: 'Histoire', questionsCount: 6 },
];
const examQuestions: Question[] = [
  // FRANÇAIS (8 questions)
  { id: 1, category: 'francais',
    question: "Quelle figure de style se cache derrière l’expression : « C’est à vous à qui je parle » ?",
    options: ["Redondance", "Pléonasme", "Anaphore", "Tautologie"],
    correctAnswers: [3] },
  {
    id: 2,
    category: 'francais',
    question: "On dit et on écrit :",
    options: ["On se rappelle quelque chose", "On se rappelle de quelque chose", "A ou B au choix", "A ou B selon le contexte"],
    correctAnswers: [1],
  },
   {
    id: 3,
    category: 'francais',
    question: "On dit et on écrit :",
    options: ["On se souvient quelque chose", "On se souvient de quelque chose", "A ou B au choix", "A ou B selon le contexte"],
    correctAnswers: [1],
  },
  {
    id: 4,
    category: 'francais',
    question: "On dit et on écrit :",
    options: ["Je l’ai vu rentrer dans ce restaurant", "Je l’ai vu entrer dans ce restaurant", "A ou B au choix", "A ou B selon le contexte"],
    correctAnswers: [1],
  },
  {
    id: 5,
    category: 'francais',
    question: "On dit et on écrit :",
    options: ["Rêver à quelque chose", "Rêver de quelqu’un", "Rêver de quelque chose", "A, B ou C selon le contexte"],
    correctAnswers: [2],
  },
  {
     id: 6,
    category: 'francais',
    question: "On dit et on écrit :",
    options: ["Écrire sur un registre ou un agenda", "Écrire dans un registre ou un agenda", "A ou B au choix", "A ou B selon le contexte"],
    correctAnswers: [1],
  },
  {
    id: 7,
    category: 'francais',
    question: "Quelle figure de style est utilisée dans « Cette faucille d'or dans le champ des étoiles » ?",
  ...
  },
  {
    id: 8,
    category: 'francais',
    question: "Conjuguez « finir » à la 3ème personne du pluriel au passé simple :",
    options: ["Ils finissent", "Ils finirent", "Ils finissèrent", "Ils finiront"],
    correctAnswers: [1],
  },
  
  // Mathématiques (8 questions)
  {
    id: 9,
    category: 'maths',
  ...
  },
  {
    id: 10,
    category: 'maths',
    question: "Calculer : $\\lim_{x \\to +\\infty} \\frac{1}{x}$",
  ...
  },
  {
    id: 12,
    category: 'maths',
   question: "Calculer : $\\int 2x , dx$",
    options: ["$x^2 + C$", "$2x^2 + C$", "$x^2$", "$2 + C$"],
    correctAnswers: [0],
    hasLatex: true,
  },
  {
    id: 13,
    category: 'maths',
    question: "Soit $f(x) = x^3$. Calculer $f'(x)$.",
  ...
  },
  {
    id: 14,
    category: 'maths',
    question: "Calculer la dérivée de $f(x) = x^3 + 2x^2 - 5x + 1$",
    options: ["$f'(x) = 3x^2 + 4x - 5$", "$f'(x) = 3x^2 + 2x - 5$", "$f'(x) = x^2 + 4x - 5$", "$f'(x) = 3x^3 + 4x - 5$"],
    correctAnswers: [0],
    hasLatex: true,
  },
  {
    id: 15,
    category: 'maths',
     question: "Résoudre : $z^2=-4$",
    options: ["$z=\\pm 2i$", "$z=\\pm 4$", "$z=2$", "aucune solution"],
    correctAnswers: [0],
    hasLatex: true,
  },
  {
    id: 16,
    category: 'maths',
    question: "Soit $z=3+4i$. Calculer $|z|$.",
    options: ["$5$", "$25$", "$\\sqrt{7}$", "$1$"],
    correctAnswers: [0],
    hasLatex: true,
  },
  // PHYSIQUE (7 questions)
  {
    id: 17,
    category: 'physique',
  ...
  },
  {
    id: 18,
    category: 'physique',
    question: "La formule $E = mc^2$ représente :",
    options: ["L'énergie cinétique", "L'énergie potentielle", "L'équivalence masse-énergie", "La force gravitationnelle"],
    correctAnswers: [2],
    hasLatex: true,
  },
  {
    id: 19,
    category: 'physique',
    question: "Quelles sont les grandeurs vectorielles ? (Plusieurs réponses)",
    options: ["La vitesse", "La masse", "La force", "La température", "L'accélération", "Le temps"],
  ...
  },
  {
    ...
    options: ["$U = R \\times I$", "$U = R / I$", "$U = R + I$", "$U = R - I$"],
    correctAnswers: [0],
    hasLatex: true,
  },
  {
    ...
    options: ["$3 \\times 10^6$ m/s", "$3 \\times 10^8$ m/s", "$3 \\times 10^5$ m/s", "$3 \\times 10^{10}$ m/s"],
    correctAnswers: [1],
    hasLatex: true,
  },
  {
    id: 22,
    category: 'physique',
    question: "Un objet de masse 2 kg tombe en chute libre. Quelle est son accélération ? (g = 10 m/s²)",
  ...
  },
  {
    id: 23,
    category: 'physique',
    question: "Quel phénomène explique la décomposition de la lumière blanche par un prisme ?",
    options: ["La réflexion", "La diffraction", "La dispersion", "L'absorption"],
    correctAnswers: [2],
  },
   // SVT (7 questions)
  {
  ...
  },
  {
    id: 25,
    category: 'svt',
    question: "Quels sont les constituants de l'ADN ? (Plusieurs réponses)",
    options: ["Adénine", "Glucose", "Thymine", "Cytosine", "Guanine", "Fructose"],
    correctAnswers: [0, 2, 3, 4],
  },
  {
    id: 26,
    category: 'svt',
    question: "La photosynthèse se déroule dans :",
    options: ["Les mitochondries", "Les chloroplastes", "Le noyau", "Les ribosomes"],
    correctAnswers: [1],
  },
  {
    id: 27,
  ...
  },
  {
    id: 28,
    category: 'svt',
    question: "Quelles maladies sont causées par des virus ? (Plusieurs réponses)",
    options: ["Le paludisme", "La grippe", "Le SIDA", "Le choléra", "La rougeole", "La tuberculose"],
  ...
  },
  {
    ...
    options: ["Défense immunitaire", "Transport d'oxygène", "Coagulation", "Transport de nutriments"],
    correctAnswers: [1],
  },

  // PSYCHOTECHNIQUE (7 questions)
  {
    id: 31,
    category: 'psychotechnique',
    question: "Complétez la suite : 2, 6, 18, 54, ...",
    options: ["108", "162", "72", "160"],
    correctAnswers: [1],
  },
  {
    id: 32,
    ...
    options: ["Chien", "Chat", "Lion", "Table"],
    correctAnswers: [3],
  },
  {
    id: 33,
    category: 'psychotechnique',
    question: "Une diaphorèse est une : ",
    options: ["Transpiration abondante", "Transpiration normale", "Absence de transpiration"],
    correctAnswers: [0],
  },
  {
    id: 34,
    category: 'psychotechnique',
    question: "Trouvez le mot qui complète logiquement la série. Un neveu - Trois soeurs - Quatre enfants - Sept tantes",
    options: ["Neuf veaux", "Douze escargots", "Quinze habits", "Vingt sacs"],
    correctAnswers: [1],
  },
  {
    id: 35,
    category: 'psychotechnique',
    question: "Trouvez le mot qui complète logiquement la série. ABRI - DEPART - EFFET - HIER - ? ",
    options: ["TOIT", "VENT", "TUILE", "BRIQUE", "TARD"],
    correctAnswers: [2],
  },
  {
    id: 36,
    category: 'psychotechnique',
    question: "Tous les chercheurs sont rigoureux. Certains rigoureux sont distraits. Peut-on affirmer que :",
    options: ["Tous les chercheurs sont distraits", "Certains chercheurs sont distraits", "Aucun chercheur n’est distrait", "Aucune des affirmations n’est certaine"],
    correctAnswers: [3],
  },
  {
    id: 37,
    category: 'psychotechnique',
    question: "Trouvez le mot qui complète logiquement la série.KOKOLOGO - OUAGAGOUGOU - POMPOI - KOUPELA - ?",
    options: ["Zorgho", "Tenkodogo", "Banfora", "Fada N'Gourma", "Sanaba"],
    correctAnswers: [4],
  },

  // CULTURE GÉNÉRALE (7 questions)
  {
    id: 38,
    category: 'culture',
    question: "Quel pays africain est le plus vaste en superficie ?",
    options: ["Soudan", "Algérie", "RDC", "Libye"],
    correctAnswers: [1],
  },
  {
    id: 39,
    category: 'culture',
   question: "Le barrage d’Assouan est situé sur quel fleuve ?",
  ...
  },
  {
    id: 40,
    category: 'culture',
    question: "Le lac Victoria est partagé par combien de pays ?",
    options: ["2", "3", "4", "5"],
    correctAnswers: [1],
  },
  {
  ...
  },
  {
    id: 42,
    category: 'culture',
    question: "L'ONU a été fondée en quelle année ?",
  ...
  },
  {
    id: 44,
    category: 'culture',
    question: "Thomas Sankara fut président de :",
    options: ["Mali", "Burkina Faso", "Niger", "Guinée"],
    correctAnswers: [1],
  },
  ...
  // HISTOIRE (6 questions)
  {
    id: 45,
    category: 'histoire',
    question: "Qui était le premier président du Burkina Faso (alors Haute-Volta) ?",
    options: ["Thomas Sankara", "Maurice Yaméogo", "Sangoulé Lamizana", "Blaise Compaoré"],
    correctAnswers: [1],
  },
  {
    id: 46,
    category: 'histoire',
    question: "En quelle année la Haute-Volta a-t-elle été renommée Burkina Faso ?",
    options: ["1980", "1984", "1987", "1990"],
    correctAnswers: [1],
  },
  {
    id: 47,
    category: 'histoire',
    question: "Quelles puissances coloniales ont colonisé des pays africains ? (Plusieurs réponses)",
    options: ["France", "Japon", "Royaume-Uni", "Portugal", "Belgique", "Chine"],
    correctAnswers: [0, 2, 3, 4],
  },
  {
    id: 48,
    category: 'histoire',
    question: "La Seconde Guerre mondiale s'est terminée en :",
  ...
  },
  {
    ...
    options: ["Empire Songhaï", "Empire du Mali", "Empire du Ghana", "Empire Mossi"],
    correctAnswers: [1],
  },
  {
    id: 50,
...
export const concoursData: Concours[] = [
  ...
  },
  {
    ...
    duration: 75, // 1h15
    available: true, // Exemple de concours indisponible
  },
  {
    id: 'exam',           // ID unique (pas d'espaces, minuscules)
    name: 'Examen Blanc', // Nom affiché
    description: 'Examen Blanc de la semaine - 50 questions',
    icon: 'EXAM',     
     categories:examCategories,                   // Emoji représentatif
    questions: examQuestions,          // Utiliser les questions de base
    duration: 90,                      // Durée en minutes
    available: true,                   // true = actif, false = indisponible
  },
